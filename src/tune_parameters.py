...
class TuneHyperParameters:
    ...
    def fit_and_evaluate(self, lr, num_layers, cell_dimension, epochs, look_back, batch_size):
        print("parameters ===>", lr, num_layers, cell_dimension, epochs, look_back, batch_size)
