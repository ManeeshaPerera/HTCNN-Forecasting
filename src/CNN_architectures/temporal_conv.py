...
def create_model(num_feat,  # type: int
                 nb_filters,  # type: int
    ...
    model.compile(get_opt(), loss='mean_squared_error', metrics=[tf.metrics.MeanAbsoluteError()])
